...
// void dijkstra(int src, int n, vector<vector<Edge>> &graph, const string &trace_file, const string &result_file)
// {
...
//     ofstream times_file("Dijkstra_execution_times.txt");
//     if (!times_file)
//     {
//         cerr << "Error: Cannot open Dijkstra_execution_times.txt\n"
//              << flush;
//         return 1;
//     }
...
//         // Build graph for the selected nodes
//         vector<vector<Edge>> graph(max_node_id + 1);
//         int subgraph_edge_count = 0;
//         for (const auto &[u, v, w] : edges)
//         {
//             if (subgraph_nodes.count(u) && subgraph_nodes.count(v))
//             {
...
//         cout << "Running Dijkstra for " << node_count << " nodes, " << subgraph_edge_count << " edges...\n"
//              << flush;

//         // Measure execution time
//         auto start = chrono::high_resolution_clock::now();
//         dijkstra(src, target_nodes, graph, "Dijkstra_trace_temp.txt", "Dijkstra_results_temp.txt");
//         auto end = chrono::high_resolution_clock::now();
//         auto duration = chrono::duration_cast<chrono::microseconds>(end - start);

//         // Save execution time
//         times_file << "Nodes: " << node_count << ", Time: " << duration.count() << " microseconds\n";
...
//     // Run Dijkstra on the full graph for final results
...
//     auto start = chrono::high_resolution_clock::now();
//     dijkstra(src, max_node_id + 1, full_graph, "Dijkstra_trace.txt", "Dijkstra_results.txt");
//     auto end = chrono::high_resolution_clock::now();
//     auto duration = chrono::duration_cast<chrono::microseconds>(end - start);

//     // Store execution time for full graph
//     ofstream time_file("Dijkstra_time.txt");
//     if (!time_file)
//     {
//         cerr << "Error: Cannot open Dijkstra_time.txt\n"
//              << flush;
//     }
//     else
//     {
...
//          << flush;
//     cout << "Results written to Dijkstra_results.txt and Dijkstra_trace.txt\n"
//          << flush;
//     cout << "Execution times for different node counts written to Dijkstra_execution_times.txt\n"
//          << flush;
